...
#def make_file():
#    file = pd.read_excel(r'C:\Users\Blake\Desktop\Batting-fix.xlsx')
#    return file
#def read_excel():
#    df = pd.read_excel(r'C:\Users\Blake\Desktop\Batting-fix.xlsx')
#    return df['playerID'].values.tolist()
#def read_excel_year():
#    df = pd.read_excel(r'C:\Users\Blake\Desktop\Batting-fix.xlsx')
#    return df['yearID'].values.tolist()

#class BrhittingSpider(scrapy.Spider):
#    file = make_file()
#    name = "BRHitting"
#    allowed_domains = []
#    backup_interval = 100
#    backup_path = r'C:\Users\Blake\Desktop\Batting-backup.xlsx'
...
#            age = (response.xpath(f'//*[@id="players_standard_batting.{year}"]//td[@data-stat="age"]/text()').get())
#            position = (response.xpath(f'//*[@id="players_standard_batting.{year}"]//td[@data-stat="pos"]/text()').get())
#            if age is None: age = (response.xpath(f'//*[@id="players_advanced_batting.{year}"]//td[@data-stat="age"]/text()').get())
#            if position is None: position = (response.xpath(f'//*[@id="players_advanced_batting.{year}"]//td[@data-stat="pos"]/text()').get())
